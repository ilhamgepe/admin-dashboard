  ...
  return (
    <div className="navbar dark:bg-slate-900 dark:border-gray-600  text-sm text-gray-500 border-b-2 border-gray-200">
      <div className="wrapper h-14 flex items-center justify-between mx-5">
        <form className="search border-[0.5px] p-1 flex items-center rounded-md dark:border-gray-400">
          <input
            type="text"
            placeholder="Search..."
            className="h-7 border-none focus:ring-0 border-2 bg-transparent dark:placeholder:text-gray-300"
          />
        ...
        <div className="items flex items-center gap-4">
          ...
          <div className="item cursor-pointer relative">
            ...
            <div className="counter text-white w-5 h-5 bg-indigo-500 rounded-full absolute -top-2 -right-2 text-center">
              5
            </div>
          </div>
          <div className="item cursor-pointer relative">
